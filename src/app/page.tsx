  ...
  const sendMessage = async () => {
    ...
    if (
      ...
      const aiMessage: Message = {
        id: Date.now() + 1,
        sender: "ai",
        content: "I was created by Mausham Prasad.",
      };
    ...
    if (
      ...
      const aiMessage: Message = {
        ...
        sender: "ai",
        content:
          "I am L.Y.N.K., a chatbot designed to assist you. I was developed by Mausham Prasad to provide helpful and intelligent conversations.",
      };
      setMessages((prev) => [...prev, aiMessage]);
      return;
    }
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { id: Date.now() + 3, sender: "ai", content: errMsg },
      ]);
    } finally {
      setIsThinking(false);
    }
